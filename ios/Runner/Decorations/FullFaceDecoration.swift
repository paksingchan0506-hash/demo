...
class FullFaceDecoration: FaceDecoration {
    func draw(in context: CGContext, landmarks: [NormalizedLandmark], width: Int, height: Int) {
        let idx = [10, 338, 297, 332, 284, 251, 389, 356, 454, 323, 361, 288, 397, 365, 379, 378, 400, 377, 152, 148, 176, 149, 150, 136, 172, 58, 132, 93, 234, 127, 162, 21, 54, 103, 67, 109]
        ...
        let up = h * 0.10
        let rect = CGRect(x: cx - w * 0.5, y: cy - h * 0.5 - up, width: w, height: h)
        if let img = loadImage(asset: "assets/masks/full_face_logo.png") {
